...
import icone from '../images/images/icons/16.png';
import $ from 'jquery';
export default class Footer extends Component {
    ...
    <div className="container"> 
        ...
        row"> 
            <div className="links-wrapper-1 col-sm-12 col-md arrow plus">
            ...
            <div className="links-wrapper-2 col-sm-12 col-md arrow plus">
                <h3>Services</h3>
                <ul >
            ...
            <div className="links-wrapper-3 col-sm-12 col-md arrow plus">
                <h3>Apple Store</h3>
                <ul>
        ...
        <div className="copyright-wrapper row">
            ...
            <div className="footer-links-terms  col-sm-12 order-2 col-lg-6 order-lg-2">
                <ul>
            ...
            <div className="footer-country  col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
                <div className="flag-wrapper"><img src={icone}/></div> <div className="footer-country-name">United States</div> 
            </div>
        </div>
    </div>
</footer> 
